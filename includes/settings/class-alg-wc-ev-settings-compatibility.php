...
if ( ! class_exists( 'Alg_WC_Email_Verification_Settings_Compatibility' ) ) :
	...
	class Alg_WC_Email_Verification_Settings_Compatibility extends
		...
		function get_settings() {
			$general = array(
				...
				array(
					...
					/* translators: %1$s, %2$s placeholder(s) */
					'desc'              => sprintf( __( 'Accept verification from "<a target="_blank" href="%1$s">WooCommerce Social Login</a>" plugin made by Woocommerce author <a href="%2$s" target="_blank">SkyVerge</a>', 'emails-verification-for-woocommerce' ), 'https://woocommerce.com/products/woocommerce-social-login/', 'https://woocommerce.com/vendor/skyverge/' ),
					'type'              => 'checkbox',
				...
				array(
					...
					/* translators: %1$s, %2$s placeholder(s) */
					'desc'              => sprintf( __( 'Accept verification from "<a target="_blank" href="%1$s">WooCommerce Social Login</a>" plugin made by CodeCanyon author <a href="%2$s" target="_blank">wpweb</a>', 'emails-verification-for-woocommerce' ), 'https://codecanyon.net/item/woocommerce-social-login-wordpress-plugin/8495883', 'https://codecanyon.net/user/wpweb' ),
					'type'              => 'checkbox',
			...
			$email_customizer_villatheme_opts = array(
				...
				array(
					...
					/* translators: %1$s, %2$s placeholder(s) */
					'desc'              => sprintf( __( 'Display the activation email content on the %1$s template using the %2$s special text', 'emails-verification-for-woocommerce' ), '<strong>' . __( 'New account', 'emails-verification-for-woocommerce' ) . '</strong>', '<code>{alg_wc_ev_viwec}</code>' ),
					/* translators: %s placeholder(s) */
			...
			$elementor_essential_addons_opts  = array(
				array(
					...
					'type'  => 'title',
					/* translators: %s placeholder(s) */
					'desc'  => sprintf( __( 'Compatibility with the %s plugin.', 'emails-verification-for-woocommerce' ), sprintf( '<a href="%s" target="_blank">%s</a>', 'https://essential-addons.com/elementor/', __( 'Essential Addons for Elementor', 'emails-verification-for-woocommerce' ) ) ),
