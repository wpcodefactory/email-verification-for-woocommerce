...
if ( ! class_exists( 'Alg_WC_Email_Verification_Settings_General' ) ) :
	...
	class Alg_WC_Email_Verification_Settings_General extends
		...
		function get_settings() {
			return array(
				...
				array(
					...
					/* translators: %1$s: my account URL, %2$s: page name */
					'desc'    => sprintf( __( 'Show account verification info on <a href="%1$s">%2$s</a> page', 'emails-verification-for-woocommerce' ), wc_get_page_permalink( 'myaccount' ), __( 'My Account', 'emails-verification-for-woocommerce' ) ),
					'type'    => 'checkbox',
				...
				array(
					...
					/* translators: %s: shortcodes admin page URL */
					...
					/* translators: %1$s: verification status shortcode, %2$s: resend URL shortcode */
					'desc_tip'          => sprintf( __( 'You can use %1$s and %2$s shortcodes here and any other one you\'d like.', 'emails-verification-for-woocommerce' ), '<strong>' . '[alg_wc_ev_verification_status]' . '</strong>', '<strong>' . '[alg_wc_ev_resend_verification_url]' . '</strong>' ),
					'type'              => 'textarea',
					'css'               => 'width:100%;height:83px;',
				...
				array(
					...
					/* translators: %1$s: option value, %2$s: option name */
				...
				array(
					...
					'desc'  => __( 'Redirects to a custom URL if an unverified user tries to login, including after a password reset.', 'emails-verification-for-woocommerce' ) . '<br /><br />' .
					           /* translators: %s: query argument name */
